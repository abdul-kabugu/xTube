...
import { CollectOutline, CommentOutline, FireOutline, LikeOutline } from '@/Icons'
export default function discover() {
 ...
 <div className={`${tab === 2 && "bg-gray-300 dark:bg-gray-700"}  flex gap-2 w-[130px] px-2 py-1 rounded-xl items-center justify-center cursor-pointer`} onClick={() => setTab(2)}>
